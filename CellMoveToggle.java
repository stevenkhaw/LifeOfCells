...
public class CellMoveToggle extends CellMoveUp {
    ...
    //MAGIC NUMBER
    public String CELL_MOVE_TOGG_STRING_ON = "T";
    public String CELL_MOVE_TOGG_STRING_OFF = "t";
    public int CELL_MOVE_TOGG_UPPER_BOUND = 5;
    public int CELL_MOVE_TOGG_LOWER_BOUND = 2;
